...
public class Session {
    ...
    private long sessionDuration; // Total session duration in minutes
     ...
     */
    public Session(long sessionDuration, String moduleName, DefaultSessionCategory... categories) {
     ...
     */
    public Session(long sessionDuration, String moduleName, String customCategory) {
        this.sessionDuration = sessionDuration;
        this.timerManager = new TimerManager(sessionDuration);
        this.breakManager = new BreakManager();
